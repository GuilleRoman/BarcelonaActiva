...
SELECT  d.DEPTNO, d.DNAME, AVG(e.SAL) FROM DEPARTAMENTOS D JOIN EMPLEADOS E ON E.DEPTNO=D.DEPTNO  
WHERE SAL IN (SELECT SAL FROM EMPLEADOS WHERE SAL > 900 AND SAL < 5000 ) GROUP BY D.DEPTNO;
