...
public class N2 {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("¿Quieres añadir algún plato más? 1:si, 2: no");
		String añadir = sc.nextLine();
		if(!añadir.equalsIgnoreCase("1")||!añadir.equalsIgnoreCase("0")) {
			throw new Exception("Introduce un número válido (0 ó 1)");
		}
		
		while(añadir.equalsIgnoreCase("1")) {
