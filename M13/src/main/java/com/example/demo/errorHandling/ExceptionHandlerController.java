...
//	}
	...
	ResponseEntity<String> handleEmptyInput(TemplateInputException e){
		return new ResponseEntity<String>(" There's a problem with your template, take a look at the model", HttpStatus.INTERNAL_SERVER_ERROR)	;
	}
	
	@ExceptionHandler(TemplateProcessingException.class)
	ResponseEntity<String> handleEmptyInput(TemplateProcessingException e){
		return new ResponseEntity<String>(" There's a problem with your template, because we couldnt parse an expression", HttpStatus.INTERNAL_SERVER_ERROR)	;
	}
